...
DOTCONTEXT_COMMANDS="setup-context spec-dc spec-quick plan-dc execute-dc code-review commit create-pr pr-comment deep-context fix-bug add-decision add-skill add-command"
